...
var script = {
  ...
  explodeSmartObject: function( initLayer ) {
    ...
    // =======================================================
		g.bounds.smartobject = activeLayer.boundsNoEffects;
    ...
    // =======================================================
		var regularSO = this.getSmartObject( initLayer, initLayerStyle );
  ...
  resizeLayer: function() {
    ...
    var newWidth = (100 / contentsWidth) * smartObjectWidth;
    ...
    var newHeight = (100 / contentsHeight) * smartObjectHeight;
	...
	getSmartObject: function( initLayer, initLayerStyle ) {
    ...
    // Rename group using doc name
    // =======================================================
    var soDoc = app.activeDocument;
    var soDoc_active = soDoc.activeLayer;
    soDoc_active.name = soLayerName;
    ...
    // Ungroup if group contains one layer + no layer styles in the parent smart object...
    if ( app.activeDocument.activeLayer.layers < 2 && !initLayerStyle ) {
  ...
  dialog: function() {
    ...
    {"activeId":20,"items":{"item-0":{"id":0,"type":"Dialog","parentId":false,"style":{"text":"UnSmart Object.jsx","preferredSize":[0,0],"margins":38,"orientation":"row","spacing":31,"alignChildren":["right","top"],"varName":null}},"item-5":{"id":5,"type":"Panel","parentId":13,"style":{"text":"Options:","preferredSize":[0,0],"margins":10,"orientation":"row","spacing":2,"alignChildren":["left","top"],"alignment":null,"varName":null}},"item-6":{"id":6,"type":"Panel","parentId":13,"style":{"text":"On Complete - Select:","preferredSize":[0,0],"margins":10,"orientation":"row","spacing":10,"alignChildren":["left","top"],"alignment":null,"varName":null}},"item-12":{"id":12,"type":"Checkbox","parentId":5,"style":{"text":"Keep Smart Object dimensions","preferredSize":[0,0],"alignment":null,"checked":false,"varName":"keepSo","helpTip":null}},"item-13":{"id":13,"type":"Group","parentId":0,"style":{"preferredSize":[0,0],"margins":0,"orientation":"column","spacing":18,"alignChildren":["fill","top"],"alignment":null,"varName":null}},"item-15":{"id":15,"type":"Button","parentId":20,"style":{"text":"Start","justify":"center","preferredSize":[0,0],"alignment":null,"varName":"ok","helpTip":null}},"item-16":{"id":16,"type":"Button","parentId":20,"style":{"text":"Cancel","justify":"center","preferredSize":[0,0],"alignment":null,"varName":"cancel","helpTip":null}},"item-18":{"id":18,"type":"Checkbox","parentId":22,"style":{"varName":"selectSo","text":"Smart Objects","preferredSize":[0,0],"alignment":null,"helpTip":null,"checked":true}},"item-19":{"id":19,"type":"Checkbox","parentId":24,"style":{"varName":"selectCont","text":"Contents","preferredSize":[0,0],"alignment":null,"helpTip":null}},"item-20":{"id":20,"type":"Group","parentId":0,"style":{"varName":null,"preferredSize":[0,0],"margins":0,"orientation":"column","spacing":10,"alignChildren":["fill","center"],"alignment":null}},"item-21":{"id":21,"type":"StaticText","parentId":5,"style":{"varName":null,"text":"(?)","justify":"left","preferredSize":[0,0],"alignment":null,"helpTip":"You can toggle this option with the number key: 1 or spacebar"}},"item-22":{"id":22,"type":"Group","parentId":6,"style":{"varName":null,"preferredSize":[0,0],"margins":0,"orientation":"row","spacing":2,"alignChildren":["left","center"],"alignment":null}},"item-23":{"id":23,"type":"StaticText","parentId":22,"style":{"varName":null,"text":"(?)","justify":"left","preferredSize":[0,0],"alignment":null,"helpTip":"You can toggle this option with the number key: 2"}},"item-24":{"id":24,"type":"Group","parentId":6,"style":{"varName":null,"preferredSize":[0,0],"margins":0,"orientation":"row","spacing":2,"alignChildren":["left","center"],"alignment":null}},"item-26":{"id":26,"type":"StaticText","parentId":24,"style":{"varName":null,"text":"(?)","justify":"left","preferredSize":[0,0],"alignment":null,"helpTip":"You can toggle this option with the number key: 3"}}},"order":[0,13,5,12,21,6,22,18,23,24,19,26,20,15,16]}
    */
    ...
    var keepSo = panel1.add("checkbox");
    ...
    var panel2 = group1.add("panel");
        panel2.text = "On Complete - Select:";
    ...
    // GROUP2
    // ======
    var group2 = panel2.add("group");
        group2.orientation = "row";
        group2.alignChildren = ["left","center"];
        group2.spacing = 2;
        group2.margins = 0;

    var selectSo = group2.add("checkbox");
    ...
    var selectCont = group3.add("checkbox");
